<?php
if (isset($_GET['sp'])) {
    $qry = pg_query($connPG, "SELECT * FROM chitiethoadon WHERE mahoadon = '{$_GET['id']}' and masanpham = '{$_GET['sp']}'");
    if ($qry) {
...
<div class="card card-outline">
    <div class="card-header">
        <h3 class="card-title"><?php echo (isset($_GET['sp']) ? "Cập nhật " : "Tạo mới ") ?> chi tiết hóa đơn</h3>
    </div>
    <div class="card-body">
...
?>
    ...
    <div class="card-footer">
        ...
        <a class="btn btn-flat btn-default" href="?page=chitiethoadon&&id=<?php echo $_GET['id'] ?>">Hủy</a>
    </div>
</div>
<script>
	...
	$.ajax({
		url: _base_url_ + 'classes/master.php?f=save_chitiethoadon',
