<div>
    <div class="card-header">
        ...
        <div class="card-tools">
            <a href="?page=tinh/manage_tinh" class="btn btn-flat btn-success rounded"><span
            ...
            <td>
                <div class="d-flex">
                    <a class="btn btn-success"
                        href="?page=tinh/manage_tinh&id=<?php echo $row['matinh'] ?>">Sửa</a>
                    <a class="btn btn-danger delete_data" href="javascript:void(0)"
                        data-id="<?php echo $row['matinh'] ?>">Xóa</a>
                </div>
            </td>
        </tr>
        <?php
